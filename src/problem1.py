...
def run_test_problem1a():
    ...
    # Test 4:
    expected = 0.105  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([3, 4], expected, test_results,
                                  format_string)
...
def run_test_problem1b():
    ...
    # Test 4:
    expected = 7
    print_expected_result_of_test([4, 7], expected, test_results, format_string)
    actual = problem1b(4, 7)
    print_actual_result_of_test(expected, actual, test_results)
