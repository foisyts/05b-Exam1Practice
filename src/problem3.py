...
def run_test_problem3a():
    ...
    # Test 5 (it is also on window 3):
    point = rg.Point(150, 10)
    expected = 88
...
def problem3a(window, point, n):
    ...
    for k in range(n):
        ...
        line = rg.Line(new_point, rg.Point(new_point.x, new_point.y + 50))
...
def problem3b(m, point1):
    ...
    for k in range(m):
        ...
        sum = sum + problem3a(window, rg.Point(point1.x, point1.y + 60 * k), 3 + k * 2)
